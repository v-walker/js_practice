...
let songs = [
    {  
        ...
        name:"Fleetwood Mac",
        publishDate:"1975",
        imgURL:"images/fleetwoodMac1975.png",
...
app.get('/', (req, res) => {
    ...
    <br><br>
    <figure>
        <img src="images/fleetwoodMac1973.jpg" alt="Fleetwood Mac in 1973" width="200px">
    ...
    <br><br>
    <figure>
        <img src="images/fleetwoodMac1977" alt="Fleetwood Mac in 1977" width="200px">
    ...
    <br><br>
    <figure>
        <img src="images/fleetwoodMac2009" alt="Fleetwood Mac in 2009" width="200px">
...
let listOfAlbums = `<ul></ul>`;
for (album of songs) {
    listOfAlbums += `<li>Album: <a href="/cds/${album.index}">${album.name}</a></li>`
};
...
app.get('/cds/:index', (req, res) => {
    ...
    let htmlBlock = `<h1>Fleetwood Mac</h1>`;
    htmlBlock += nav;
